const projectsData = [
    ...
    { title: "MyLibrary en React et Node", description: "Application web de gestion de livres", image: require('../assets/project.jpg') },
    { title: "MyCine en Angular et Node", description: "Description du projet 3", image: require('../assets/project.jpg') },
    { title: "Tenzi en React", description: "Jeu de Tenzi", image: require('../assets/project.jpg') },
    { title: "GSB en Zend", description: "Application back-office de gestion de médecins", image: require('../assets/project.jpg') },
    { title: "KbTravel en PHP", description: "Site internet de déservation de billets d'avion", image: require('../assets/project.jpg') },
